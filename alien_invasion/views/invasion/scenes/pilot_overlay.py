...
class PilotOverlay(arc.Scene):
    ...
    def draw(self) -> None:
        ...
        arc.draw_text(
            ...
            start_x=self.starship.center_x - 80 * CONSTANTS.DISPLAY.SCALE_RELATION,
            start_y=self.starship.top + 22 * CONSTANTS.DISPLAY.SCALE_RELATION,
            color=arc.color.AERO_BLUE
            if not self.starship.free_falling
            else arc.color.MAYA_BLUE,
            font_size=16 * CONSTANTS.DISPLAY.SCALE_RELATION,
            font_name="Courier New",
        )
        ...
        if self.starship.state.index != 1:
            arc.draw_text(
                ...
                start_x=self.starship.center_x + 30 * CONSTANTS.DISPLAY.SCALE_RELATION,
                start_y=self.starship.top + 22 * CONSTANTS.DISPLAY.SCALE_RELATION,
        ...
        arc.draw_text(
            f"{self.starship.xp}",
            start_x=self.starship.center_x + 45 * CONSTANTS.DISPLAY.SCALE_RELATION,
            start_y=self.starship.center_y - 15 * CONSTANTS.DISPLAY.SCALE_RELATION,
